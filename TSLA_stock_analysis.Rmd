...
```{r results='hold',message=FALSE}
#2a,b,c,d,d: construct a model with a full set set of seasonal dummies, plot the seasonal factors, interpret plot, add trend from problem 1, interpret the summary, do h-step forecast (h>16)
