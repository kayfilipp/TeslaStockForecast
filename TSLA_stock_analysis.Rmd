...
Overall, the AIC/BIC suggests that the nonlinear model is better than the linear model with regards to forecasting strength.
Residuals seem to behave uniformly in both models, with slightly more spread in the nonlinear model. Residuals for the linear
model seem to follow a relatively normal distribution while nonlinear residuals, as dictated by the histograms, display prominent
spikes on either side of the mode, suggesting the distribution is not unimodal.
...
```{r results='hold',message=FALSE}
plot(forecast(nl_m$fitted.values ,h=24) ,shadecols="oldstyle", main="TSLA Stock Non-Linear Model Forcast", xlab="Year", ylab="Log-Adjusted Closing Price (in $)",lwd=2, col=1)
